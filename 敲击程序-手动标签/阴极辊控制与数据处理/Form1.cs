...
namespace 阴极辊控制与数据处理
{
    ...
    public partial class Form1 : UIForm
    {
        ...
        // ========== 空包/非空文件名前缀标记 ==========
        private string _currentPackagePrefix = "";
        public Form1()
        {
            InitializeComponent();
        ...
        private void uiButton9_Click(object sender, EventArgs e)
        {
            ...
            string fileName = $"{_currentPackagePrefix}{timeStr}_{FILEINDEX}.wav";           // 前缀+时间+编号
            ...
            FILEINDEX++;
            // ==========重置前缀-每次手动采集后清空，避免下次带错 ==========
            _currentPackagePrefix = "";
        }
        ...
        {
            // ========== 设置空包前缀 ==========
            _currentPackagePrefix = "空包_";
            Log("已选择：空包模式，手动采集文件名将带前缀");
        ...
        {
            // ========== 设置非空前缀 ==========
            _currentPackagePrefix = "非空_";
            Log("已选择：非空模式，手动采集文件名将带前缀");
